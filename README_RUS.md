...
Данный проект выполнялся по учебной программе [Школы 21](https://21-school.ru). В данном проекте я реализовал аллокацию матрицы в одном участке памяти для эффективности работы. Все функции покрыты юнит тестами и задокументированы.
